    ...
    <div className="space-y-3 w-full h-full m-2 sm:m-4 md:m-10">
      ...
      >
        {selectedTab === "Search" && (
          ...
          >
            <SearchIcon className="size-4 mt-0.5" />
          </motion.div>
        )}
        <motion.input
          layout
          ...
          className="w-full h-full border border-[var(--colors-gray6)] rounded-[20px] text-black focus:outline-[var(--colors-focus)] overflow-clip"
            ...
            <div className="flex items-center space-x-2">
              <Tooltip content="Add files" side="bottom" align="start">
                <motion.button
                  ...
                  className="size-9 flex items-center justify-center rounded-full border-[1px] border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200"
                >
